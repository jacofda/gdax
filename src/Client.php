...
class Client
{
    ...
    {
        return $this->getAndDecodeData('profiles');
    }
    
    public function profileTransfer(array $params = [])
    {
        return $this->postAndDecodeData('profiles/transfer', $params);
    }
    ...
    {
        return $this->getAndDecodeData('products/'.$productId);
    }
    ...
    public function getFees($user)
    {
        return $this->getAndDecodeData('fees');
    }
}